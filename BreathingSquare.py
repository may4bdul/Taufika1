...
movingSquare = visual.Rect(myWin, width=200, height=200, fillColor='red', lineColor=None)
occludingSquare = visual.Rect(myWin, width=200, height=200, fillColor='black', lineColor=None)

myScale = visual.RatingScale(myWin, pos=[0, -360], low=100, high=180,  textSize=0.5, lineColor='black',  tickHeight=False, scale=None, showAccept=False, singleClick=True)
information=visual.TextStim(myWin, pos=[0,-385], text='', height=18, color='black') 
title=visual.TextStim(myWin, pos=[0,305], text='Breathing Square Illusion', height=24, color='green') 
